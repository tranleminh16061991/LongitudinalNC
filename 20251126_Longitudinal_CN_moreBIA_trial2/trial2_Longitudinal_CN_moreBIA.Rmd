...
remove_list <- c("E_237", "F_242", "a_531", "E_391", "G_31", "F_385", "a_281", "G_71") #9962 "K_368" , 5971 "G_71"
...
```{r}
bia_vars <- c("MMSE","SNSB_attention","SNSB_language", "SNSB_visuospatial", "SNSB_memory", "SNSB_frontal","bmi","whr","pbcm","pbf","bmr","icw", "ecw", "tbw", "protein", "amc",
              "ECW_TBW_upper","ECW_TBW_lower",
